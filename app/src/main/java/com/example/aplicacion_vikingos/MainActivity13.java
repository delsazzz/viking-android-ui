...
public class MainActivity13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MaterialCardView inglaterra = findViewById(R.id.cardview_inglaterra);

        // Click listener
        inglaterra.setOnClickListener(v -> {
            Intent intent = new Intent(MainActivity13.this, MainActivity14.class);
            startActivity(intent);
        });

        ImageView atras8 = findViewById(R.id.atras8);

        // Click listener
        atras8.setOnClickListener(v -> {
            Intent intent = new Intent(MainActivity13.this, MainActivity3.class);
            startActivity(intent);
        });
    ...
    private void procesarComando(String comando) {
        ...
        if (comando.contains("inglaterra")) {

            Toast.makeText(this, "Entrando a incursión en Inglaterra...", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(this, MainActivity14.class));
        }
        else {
            Toast.makeText(
